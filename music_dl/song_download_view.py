...
class SongDownloadView(object):
    ...
    def __init__(self, model, controller, MainWindow):
        ...
        self.web_scrape_retry_spinbox.valueChanged.connect(self._controller.web_scrape_change)
    ...
    def setupUi(self, MainWindow):
        ...
        self.web_scrape_retry_spinbox = QtWidgets.QSpinBox(self.gridLayoutWidget_4)
        self.web_scrape_retry_spinbox.setMinimum(1)
        self.web_scrape_retry_spinbox.setMaximum(20)
        self.web_scrape_retry_spinbox.setProperty("value", 5)
        self.web_scrape_retry_spinbox.setObjectName("web_scrape_retry_spinbox")
        self.gridLayout_3.addWidget(self.web_scrape_retry_spinbox, 2, 2, 1, 1)
        self.web_scrape_retry_label = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.web_scrape_retry_label.setObjectName("web_scrape_retry_label")
        self.gridLayout_3.addWidget(self.web_scrape_retry_label, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.retry_wait_time_spinbox, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.retry_wait_time_label, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.web_scrape_retry_label.setToolTip(_translate("MainWindow", "Number of times to retry the web scraping if it fails"))
        self.web_scrape_retry_label.setText(_translate("MainWindow", "Web Scrape Retries (1 - 20 )"))
